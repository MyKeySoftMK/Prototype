...
#Region "Entity Framework"
    ...
    Private _EntityConnectionData As ConnectionStringSqlClientData

    Public Property EntityConnectionData As ConnectionStringSqlClientData
        Set(value As ConnectionStringSqlClientData)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Function CreateServerConn(DataBaseModelName As String, Optional DataServer As DatabaseServer = Nothing) As ConnectionStringSqlClientData

        Dim ServerConn As New ConnectionStringSqlClientData
        With ServerConn
