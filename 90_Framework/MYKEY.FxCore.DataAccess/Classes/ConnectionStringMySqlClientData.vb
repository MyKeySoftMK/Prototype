...
Public Class ConnectionStringMySqlClientData
    ...
    ' underlying provider.
    Private sqlBuilder As New MySqlConnectionStringBuilder
    ...
    Public Property DatabaseServerPort As Integer = 3306
    ...
    Public ReadOnly Property EntityConnectionString As String
        Get
            ...
            With entityBuilder
                ...
                .ProviderConnectionString = MySqlConnectionString
