...
Public Interface IOlbMenuGroupManagement_ModelEntryPoints
...
#Region "Queries"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Function EntryPoint_DefineDefaultQuery(currentDefaultQuery As DbQuery(Of MenuGroup))
...
#Region "Functions"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_BeforeAddNewMenuGroup(MenuGroupEntity As MenuGroup)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_CheckAddNewMenuGroup(Dbctx As Entities, MenuGroupEntity As MenuGroup) As Boolean
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_CopyMenuGroup(MenuGroupEntityCopy as MenuGroup) As MenuGroup
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_GenerateValidMenuGroupEntity() As MenuGroup
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_AfterAddNewMenuGroup(MenuGroupEntity As MenuGroup) As ServerResult
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_BeforeModifyMenuGroup(MenuGroupEntity As MenuGroup) As ServerResult
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_ModifyEntityBeforeModifyMenuGroup(MenuGroupEntity As MenuGroup) As MenuGroup
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_AfterModifyMenuGroup(MenuGroupEntity As MenuGroup) As ServerResult
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_AfterDeleteMenuGroup(MenuGroupEntity As MenuGroup) As ServerResult
