...
Public Interface IPrintInputControlManagement_ModelEntryPoints
...
#Region "Queries"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Function EntryPoint_DefineDefaultQuery(currentDefaultQuery As DbQuery(Of InputControl))
...
#Region "Functions"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_BeforeAddNewInputControl(InputControlEntity As InputControl)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_CheckAddNewInputControl(Dbctx As Entities, InputControlEntity As InputControl) As Boolean
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_CopyInputControl(InputControlEntityCopy as InputControl) As InputControl
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_GenerateValidInputControlEntity() As InputControl
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_AfterAddNewInputControl(InputControlEntity As InputControl) As ServerResult
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_BeforeModifyInputControl(InputControlEntity As InputControl) As ServerResult
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_ModifyEntityBeforeModifyInputControl(InputControlEntity As InputControl) As InputControl
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_AfterModifyInputControl(InputControlEntity As InputControl) As ServerResult
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_AfterDeleteInputControl(InputControlEntity As InputControl) As ServerResult
