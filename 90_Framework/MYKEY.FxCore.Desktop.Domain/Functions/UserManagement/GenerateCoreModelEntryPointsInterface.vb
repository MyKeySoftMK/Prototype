...
Public Interface IUserManagement_ModelEntryPoints
...
#Region "Queries"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Function EntryPoint_DefineDefaultQuery(currentDefaultQuery As DbQuery(Of User))
...
#Region "Functions"
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_BeforeAddNewUser(UserEntity As User)
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_CheckAddNewUser(Dbctx As Entities, UserEntity As User) As Boolean
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_CopyUser(UserEntityCopy as User) As User
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_GenerateValidUserEntity() As User
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_AfterAddNewUser(UserEntity As User) As ServerResult
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_BeforeModifyUser(UserEntity As User) As ServerResult
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_ModifyEntityBeforeModifyUser(UserEntity As User) As User
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_AfterModifyUser(UserEntity As User) As ServerResult
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
	Function EntryPoint_AfterDeleteUser(UserEntity As User) As ServerResult
