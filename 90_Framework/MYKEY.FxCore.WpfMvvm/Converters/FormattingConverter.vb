...
#Region " Methods "
    ...
    '''        If you do not use the {}{0:c} syntax, then it is necessary to escape the "{" and "}" otherwise parser will get confused 
    '''        because "{" and "}" is used as delimiters in the Binding statement.
    ...
    ''' </remarks>
    Public Function Convert(ByVal value As Object, ByVal targetType As System.Type, ByVal parameter As Object, ByVal culture As System.Globalization.CultureInfo) _
    ...
    ''' </summary>
    Public Function ConvertBack(ByVal value As Object, ByVal targetType As System.Type, ByVal parameter As Object, ByVal culture As System.Globalization.CultureInfo) _
